...
| date | `2026-05-26` |
| gold_close | `4,500.40` |
| long_baseline_8w | `10.90 pct points` |
| long_candidate_26w | `-10.90 pct points` |
| long_alignment_status | `BASELINE_POSITIVE_CANDIDATE_NEGATIVE` |
| short_baseline_8w | `-2.56 pct points` |
| short_candidate_2w | `-7.05 pct points` |
| short_candidate_4w | `-15.38 pct points` |
| short_candidate_fast_avg | `-11.22 pct points` |
| short_alignment_status | `SAME_DIRECTION_NEGATIVE` |
| net_baseline_8w | `7.05 pct points` |
...
| Reading | Count |
|---|---:|
| MEDIUM_TERM_STRUCTURE_WEAKENING | 384 |
